...
Gamintojas gali savarankišai užbaigti savaitės planą, tokiu atvejus visas savaitės planas bus užbaigtas ir nebebus galima atlikti jokiu pakeitimų.
...
- **PATCH** | `/customers/:id/change-menu-quantity` (dokumentacijos nuoroda: `URL`)
  Gamintojas gali keisti kliento meniu pasirinkimo kiekį (default – 1). Po sėkmingo atnaujinimo priekinėje dalyje turi būti inicijuojamas duomenų atnaujinimas:
  **GET** : `/customers`
